  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="md:hidden bg-white dark:bg-gray-900 border-t py-4 max-h-[80vh] overflow-y-auto">
            {navLinks.map((link) => (
              <button
                key={link.to}
                onClick={() => {
            ...
            {!isAuthenticated && (
              <div className="flex gap-2 px-4 pt-4 border-t mt-2">
                ...
                <button
                  ...
                  className="flex-1 text-center py-2.5 bg-amber-500 text-gray-900 rounded-xl"
                >
                  Sign Up
                </button>
              </div>
