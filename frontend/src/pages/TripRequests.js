  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 pt-24 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {requests.length === 0 ? (
          <div className="text-center py-16 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-100 dark:border-gray-700">
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium">
                        {req.trip?.fromCity || req.trip?.route?.from}
                      </span>
                      <span>→</span>
                      <MapPinIcon className="w-4 h-4 text-green-500" />
                      <span className="font-medium">
                        {req.trip?.toCity || req.trip?.route?.to}
                      </span>
                    </div>
                    ...
                    <div className="flex-1">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                        <div className="flex items-center gap-2 text-gray-600">
                          ...
                          {req.passenger?.email || "Not available"}
                        </div>
                      </div>
                      {req.message && (
